...
(function(t, e) {
  ...
  if (!i.TweenLite) {
    ...
    var I = v(
        ...
        function(e, i, s) {
          if (
            (C.call(this, i, s), (this.render = I.prototype.render), null == e)
          )
        ...
        if (t >= l)
          ...
          (1 === f || (3 === f && u >= 0.5)) && (u = 1 - u),
            ...
            1 === m
              ...
              : 2 === m
                ? (u *= u * u)
                : 3 === m ? (u *= u * u * u) : 4 === m && (u *= u * u * u * u),
            (this.ratio =
              1 === f ? 1 - u : 2 === f ? u : 0.5 > t / l ? u / 2 : 1 - u / 2);
